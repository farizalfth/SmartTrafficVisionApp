...
class _LiveCCTVScreenState extends State<LiveCCTVScreen> {
    ...
    return Scaffold(
      ...
      body: Consumer<CCTVDataSource>(
        builder: (context, dataSource, child) {
          ...
          // Filter List (Search & Exclude Current)
          ...
          // Handle case jika CCTV yang dipilih dihapus
              ...
              children: [
                ...
                if (filteredList.isEmpty && _searchQuery.isNotEmpty)
                  const Center(child: Padding(
                    ...
                    child: Text("Tidak ditemukan CCTV yang cocok.", style: TextStyle(color: Colors.grey)),
                  ))
                else
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Lokasi: ${cctv.location}", style: const TextStyle(color: Colors.grey)),
                const SizedBox(height: 12),
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: cctv.status == 'Online' ? Colors.green.withOpacity(0.2) : Colors.red.withOpacity(0.2),
                        borderRadius: BorderRadius.circular(4),
                        border: Border.all(color: cctv.status == 'Online' ? Colors.green : Colors.red),
                      ),
                      child: Text(
                        "Status: ${cctv.status}",
                        style: TextStyle(
                    ...
                    const Column(
                      ...
                      children: [
                        Text("Kepadatan: Macet (85%)", style: TextStyle(fontSize: 12, color: Colors.white70)),
                        Text("Jumlah Kendaraan: 237", style: TextStyle(fontSize: 12, color: Colors.white70)),
                      ],
                    )
                  ],
                )
  ...
  // --- GRID LIST DENGAN THUMBNAIL SERAGAM ---
        ...
        return GestureDetector(
          ...
          child: Card(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // THUMBNAIL SERAGAM (Placeholder Style)
                Expanded(
                  child: Container(
                    decoration: const BoxDecoration(
                      borderRadius: BorderRadius.vertical(top: Radius.circular(12)),
                      color: Colors.black26, // Background Gelap
                    ),
                    child: Center(
                      // Ikon Play Merah di Tengah
                      child: Container(
